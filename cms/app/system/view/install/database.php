    ...
    <div class="row">
        ...
        <form action="" class="form-horizontal" method="post" onsubmit="post(event)">
            <div class="col-sm-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="host" value="" placeholder="请输入主机IP"  >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">帐号</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="user" value="" placeholder="请输入帐号" >
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div>
                    <a href="{{u('check')}}" class="btn btn-default">上一步</a>
